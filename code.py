...
katataksh_A.to_csv(r"C:\Users\Kostas\Desktop\katataksh_A.csv",index=False,header=False)
#plot of LotArea
...
print("katataksh B \n",katataksh_B)
katataksh_B.to_csv(r"C:\Users\Kostas\Desktop\katataksh_B.csv",index=False)
...
print("katastash C: \n" ,katataksh_C)
katataksh_C.to_csv(r"C:\Users\Kostas\Desktop\katataksh_C.csv",index=False)
...
katataksh_D = pd.DataFrame(katataksh_D, columns=['ATTRIBUTE', 'Mean', 'Variance', 'Stdv']).sort_values(by=['Stdv'],
                                                                                                       ascending=False)
print("KATASTASH D \n" ,katataksh_D)
katataksh_D.to_csv(r"C:\Users\Kostas\Desktop\katataksh_D.csv",index=False)
...
katataksi_e.to_csv(r"C:\Users\Kostas\Desktop\katataksh_E.csv",index=False)
...
katataksi_F.to_csv(r"C:\Users\Kostas\Desktop\katataksh_F.csv",index=False)
...
#create Sale Price Dataframe
saleprice = pd.DataFrame(data=saleprice , columns=["Id" , 'SalePrice'])


#export results to csv
# saleprice.to_csv(r"C:\Users\Kostas\Desktop\saleprice.csv" , index=False)
